...
SEMP="<rpc><show><log><rest><rest-delivery-point></rest-delivery-point><errors></errors><wide></wide></rest></log></show></rpc>"
...
# curl -u admin:admin "http://localhost:8080/SEMP" -d '<rpc><show><log><rest><rest-delivery-point></rest-delivery-point><errors></errors><wide></wide></rest></log></show></rpc>' -s
